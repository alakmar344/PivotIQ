...
export function IdeaInput({ onSubmit, loading }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="fade-in bg-card border border-border rounded-2xl p-6 md:p-8 max-w-3xl w-full mx-auto">
      <textarea
        value={idea}
        ...
        className="w-full h-40 bg-surface border border-border rounded-xl p-4 text-textPrimary focus:outline-none focus:ring-2 focus:ring-primary"
      />
      ...
      <button
        ...
        className="mt-4 px-5 py-3 bg-primary hover:bg-primaryHover disabled:opacity-50 rounded-lg font-medium"
      >
        Validate My Idea →
      </button>
